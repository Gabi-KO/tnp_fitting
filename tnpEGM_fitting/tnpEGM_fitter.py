...
parser.add_argument('-m'           , '--mcSig'            , action='store_true'  , help = 'fit MC nom [to init fit parama]')
...
parser.add_argument('--runNumber', type=str, help = 'number for file name')
#parser.add_argument('--configuration', type=str, help= 'Data or Monte Carlo')


args = parser.parse_args()

#print('What is the number of this run?')
#run_num = str(input())
run_num = args.runNumber

#print('Data or Monte Carlo? d/m')
#choice = str(input())
...
if args.checkBins:
    ...
    #print('*****CALLING THE BIN DEFINITIONS*****')
...
if  args.doFit:
    ...
    #run in loop instead of parallel
    #for ib in range(len(tnpBins['bins'])):
        #parallel_fit(ib)
...
if args.sumUp:
    ...
    egm_sf.doEGM_SFs(effFileName,sampleToFit.lumi,choice)
