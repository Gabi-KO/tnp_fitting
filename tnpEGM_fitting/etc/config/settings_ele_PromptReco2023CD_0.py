...
baseOutDir = '/uscms/home/gkennedy/nobackup/ScientificLinux7/CMSSW_11_2_0/src/egm_2/fit_tests7_1' #OUTPUT DIRECTORY
...
biningDef = [
   { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5,-2.0] },
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [10,20] },
]
...
#tnpParNomFit = [
    #"meanP[-1.341,-5.0,5.0]","sigmaP[1.180,0.5,5.0]",
    #"meanF[-1.273,-5.0,5.0]","sigmaF[2.544,0.5,5.0]",
    #"acmsP[59.470,50.,80.]","betaP[0.065,0.01,0.08]","gammaP[0.041, -2, 2]","peakP[90.0]",
    #"acmsF[50.,50.,80.]","betaF[0.080,0.01,0.08]","gammaF[0.029, -2, 2]","peakF[90.0]",
#]
